...
The BAM files contain Cell Ranger-aligned reads with CB (cell barcode) and UB (UMI) tags. After downloading the Seurat objects from Zenodo, you can extract the feature and barcode files:
