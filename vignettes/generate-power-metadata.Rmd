...
**Reference Data:** [https://zenodo.org/records/19072084](https://zenodo.org/records/19072084)
...
The BAM files contain Cell Ranger-aligned reads with CB (cell barcode) and UB (UMI) tags. Use the Cell Ranger output directory for feature and barcode files:
